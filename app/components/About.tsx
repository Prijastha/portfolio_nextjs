...
const About = () => {
  return (
    <div className="h-screen relative flex  flex-col items-center justify-center  text-center max-w-4xl mx-auto px-4">
      {/* Heading */}
      <h3 className="uppercase tracking-[20px] text-gray-500 text-2xl mb-40">
        About
      </h3>
      ...
      <div className="space-y-12 ">
        ...
        <div className="flex items-center justify-center gap-6 text-gray-400 mt-6">
          <FaHtml5 className="hover:text-orange-700 text-5xl" />
          <FaCss3Alt className="hover:text-orange-700 text-5xl" />
          <IoLogoJavascript className="hover:text-orange-700 text-5xl" />
          <FaReact className="hover:text-orange-700 text-5xl" />
          <RiTailwindCssFill className="hover:text-orange-700 text-5xl" />
          <RiNextjsFill className="hover:text-orange-700 text-5xl" />
        </div>
      </div>
    </div>
  );
